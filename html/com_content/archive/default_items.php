		...
		<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
			<div class="article-info muted">
				...
				<?php if ($params->get('show_publish_date')) : ?>
					<dd>
						<div class="published uk-flex uk-flex-middle">
							<i class="uk-margin-small-right" data-uk-icon="icon: calendar"></i>
				...
				<?php if ($info == 0) : ?>
					<?php if ($params->get('show_modify_date')) : ?>
						<dd>
							<div class="modified uk-flex uk-flex-middle">
								<i class="uk-margin-small-right" data-uk-icon="icon: calendar"></i>
					...
					<?php if ($params->get('show_create_date')) : ?>
						<dd>
							<div class="create uk-flex uk-flex-middle">
								<i class="uk-margin-small-right" data-uk-icon="icon: calendar"></i>
					...
					<?php if ($params->get('show_hits')) : ?>
						<dd>
							<div class="hits uk-flex uk-flex-middle">
								<i class="uk-margin-small-right" data-uk-icon="icon: happy"></i>
